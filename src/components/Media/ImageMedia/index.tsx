...
type ImageMediaProps = Omit<MediaProps, 'boxWidth' | 'boxHeight' | 'boxClassName' | 'rounded'>
export const ImageMedia: React.FC<ImageMediaProps> = (props) => {
  ...
  let alt = staticMediaAlt || ''
  let src: StaticImageData | string = staticMediaSrc || ''

  if (!src && !alt && resource && typeof resource === 'object') {
